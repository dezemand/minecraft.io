...
export default class MinecraftStoreClient extends MinecraftStore {
  public find (query: StoreQuery = {}): Set<MinecraftClient> {
  ...
  public addClient (client: MinecraftClient): boolean {
  ...
  public others (client: MinecraftClient): (MinecraftClient) => void {
    return callback => {
  ...
  public del (client: MinecraftClient): void {
